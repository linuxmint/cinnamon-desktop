...
typedef enum
{
  C_DESKTOP_BACKGROUND_SHADINC_SOLID,
  C_DESKTOP_BACKGROUND_SHADINC_VERTICAL,
  C_DESKTOP_BACKGROUND_SHADINC_HORIZONTAL
...
typedef enum
{
  C_DESKTOP_MAGNIFIER_MOUSE_TRACKINC_MODE_NONE,
  C_DESKTOP_MAGNIFIER_MOUSE_TRACKINC_MODE_CENTERED,
  C_DESKTOP_MAGNIFIER_MOUSE_TRACKINC_MODE_PROPORTIONAL,
  C_DESKTOP_MAGNIFIER_MOUSE_TRACKINC_MODE_PUSH
